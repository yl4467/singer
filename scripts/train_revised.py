...
#from models.animate.face_animate import FaceAnimatePipeline
...
from models.datasets.talk_video import TalkingVideoDataset
...
class Net(nn.Module):
    ...
    def forward(
        ...
        audio_emb = self.audioembed(audio_emb, noisy_latents)
        # condition forward
...
def log_validation(
    ...
    audioembedder = ori_net.audioembed
...
def train_stage2_process(cfg: argparse.Namespace) -> None:
    ...
    audioembedder = MultiSpectralAttentionLayer(cfg.data.train_bs, cfg.data.n_sample_frames, 4, 64, 64)
